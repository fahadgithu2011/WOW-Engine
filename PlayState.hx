...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['F..k!', 0.2], //From 0% to 19%
		['S..t', 0.4], //From 20% to 39%
	...
	override public function create()
	{
		...
		timeTxt = new FlxText(STRUM_X + (FlxG.width / 2) - 248, 20, 400, "", 27);
		timeTxt.setFormat(Paths.font("vcr.ttf"), 27, 0xFF0000, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		botplayTxt = new FlxText(400, timeBarBG.y + 55, FlxG.width - 800, "Oh MY GOD Mythic FFAR 1 call of duty mobile", 32);
	...
	override public function update(elapsed:Float)
	{
		...
		if(ratingString == '?') {
			scoreTxt.text = 'Max Score: ' + songScore + ' | bf Breaks: ' + songMisses + ' | Accuracy: ' + ratingString;
		} else {
			scoreTxt.text = 'Max Score: ' + songScore + ' | bf Breaks: ' + songMisses + ' | Accuracy: ' + ratingString + ' (' + Math.floor(ratingPercent * 100) + '%)';
		}
